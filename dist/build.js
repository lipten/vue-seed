	...
	;(function ($) {
	    ...
	    $(document).ready(function () {
	        ...
	        $(document).bind('MSGestureEnd', function (e) {
	            ...
	            e.Touches = e.originalEvent ? e.originalEvent.changedTouches : e.touches; //Adaptive jquery&&zepto
	            ...
	            e.Touches = e.originalEvent ? e.originalEvent.changedTouches : e.touches;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var configRouter = __webpack_require__(19);
	/*通用類庫先加載*/
	var $ = __webpack_require__(1);
	var fastclick = __webpack_require__(15);
	
	var lazyload = __webpack_require__(6);
	Vue.use(lazyload, {
	  error: './img/error.png',
	...
	// var baseUrl = 'http://192.168.19.7/tupai/backend/planb/public'
	var baseUrl = 'http://wechupin.com';
	
	$.getData = function (url, initData) {
	  if (sessionStorage.getItem(url)) {
	    return JSON.parse(sessionStorage.getItem(url)).data;
	  } else {
	    return initData || {};
	  }
	};
	
	$.getUrl = function (url, func, force) {
	  // 如果有强制请求的话不存缓存
	  if (force) {
	    return $.ajax({
	      url: baseUrl + url,
	    ...
	    if (!sessionStorage.getItem(url)) {
	      ...
	      return func && func(JSON.parse(sessionStorage.getItem(url)));
	    }
	  }
	};
		...
		router.map({
			...
			'/demo': {
				component: function (resolve) {
					__webpack_require__.e/* require */(0, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(21)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
				}
			}
		});
	};
